    ...
    <div className="">
      <div className="flex justify-center gap-2 mb-6">
        <TextInput
          ...
          value={csUrl}
          onChange={setCsUrl}
          className="input input-bordered input-xs w-full md:max-w-[60%]"
        />
        <button
          onClick={
          ...
          <table className="table table-xs border-y-2 border-base-200">
            ...
            <tbody>
              {magic.map((m, i) => (
                <tr
                  key={i}
                  className={`${m.name && m.cost ? 'hover' : ''} grid md:table-row grid-cols-magic items-center`}
                >
                  ...
                  <td className="col-start-2 col-end-7 flex md:table-cell gap-0.5">
                    <span
                      className={`md:hidden relative before:content-['*'] inline-block text-primary text-[1.5em] translate-y-[0.2em] ${antiqua.className}`}
                    ></span>
                    {m.effect}
                  </td>
                </tr>
      ...
      <Tab title="内容の最終調整＆出力" className="mb-5">
        {magic.length ? (
          <>
            ...
            <div className="grid grid-cols-1 gap-3 w-full max-w-[540px]">
