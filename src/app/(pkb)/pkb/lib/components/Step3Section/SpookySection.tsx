...
import { Spooky } from '@/pkb/constants'
...
const SpookySection = memo(function SpookySection({
  ...
  const { addToastAlert } = useContext(ToastAlertsContext)
  ...
  return (
    <>
      <CharaSummary>
        <TextWithBadge badgeText="名前" badgeColor="warning">
          {spooky.name}
        </TextWithBadge>
        ...
        <TextWithBadge badgeText="攻撃力" badgeColor="warning">
          {spooky.attack}
        </TextWithBadge>
        <TextWithBadge badgeText="防御力" badgeColor="warning">
          {spooky.defense}
        </TextWithBadge>
        <TextWithBadge badgeText="お助け力" badgeColor="warning">
          {spooky.help}
        </TextWithBadge>
        <TextWithBadge badgeText="お邪魔力" badgeColor="warning">
          {spooky.interrupt}
        </TextWithBadge>
        <TextWithBadge badgeText="魔法" badgeColor="warning">
      ...
      <div className="grid grid-cols-1 gap-4 md:gap-5 md:max-w-[500px] mt-4 md:mt-6">
        ...
        <ConfirmFormBox titleColor="secondary" title="キャラクターメモ">
          <TextareaInput
            ...
            className="textarea-md w-full h-[300px]"
          />
        </ConfirmFormBox>
